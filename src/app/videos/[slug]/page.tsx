...
import { Youtube, Github, ArrowLeft, Share2, Calendar, Clock } from 'lucide-react'
    ...
    <>
      ...
      <main className="min-h-screen pt-20">
        <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
          ...
          <Link
            href="/videos"
            className="mb-8 flex w-fit items-center gap-2 rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] px-4 py-2 text-sm text-brand-muted transition-all hover:border-brand-blue/40 hover:text-brand-blue"
          >
